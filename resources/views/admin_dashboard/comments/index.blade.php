                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a target="_blank" href="{{ route('posts.show',$comment->post->slug)}}#comment_{{$comment->id}}" class="btn btn-primary btn-sm">View Comment</a>
                                </td>
                                ...
                                <td>
                                    <div class=" d-flex order-actions">
                                        <a href="{{ route('admin.comments.edit',$comment)}}" class="">
