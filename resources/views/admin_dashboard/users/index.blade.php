                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.users.show',$user)}}" class="btn btn-primary btn-sm">Related Posts</a>
                                </td>
                                ...
                                <td>
                                    <div class=" d-flex order-actions">
                                        ...
                                        <a href="#" onclick="event.preventDefault(); document.getElementById('delete_form_{{ $user->id}}').submit();" class="ms-3">
