                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.tags.show',$tag)}}" class="btn btn-primary btn-sm">Related Posts</a>
                                </td>
                                ...
                                <td>
                                    <div class=" d-flex order-actions">
                                        ...
                                        <a href="#" onclick="event.preventDefault(); document.getElementById('delete_form_{{ $tag->id}}').submit();" class="ms-3">
